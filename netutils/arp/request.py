...
def send_arp_request(ip_dst: str, mac_dst:str, ip_src: str, mac_src: str, iface: str, printed=True)->bool:
    ...
    try:
        ...
        if printed:
            print(
                f"{Back}[{Purple}{iface}{Clear}{Back}] Sent ARP request: {Orange}{ip_src}{Clear}{Back} -> {Blue}{mac_dst}{Clear}{Back}: {Dark_light_blue}who has {Blue}{ip_dst}{Dark_light_blue}? Tell {Orange}{ip_src}{Clear}")
