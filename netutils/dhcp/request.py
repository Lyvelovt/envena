...
def send_dhcp_request(ip_src: str, ip_dst: str, xid: int, hostname: str=None, iface: str=None,
    ...
    try:
        ...
        if printed:
            print(
                f"{Back}[{Purple}{iface}{Clear}{Back}] DHCP request: {Orange}{ip_src}{Clear}{Back} -> {Blue}255.255.255.255{Clear}{Back}: {Dark_light_blue}Requested address accepted. {Orange}{ip_src} {Dark_light_blue}is at {Orange}{mac_src}{Clear}")
