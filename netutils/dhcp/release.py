...
def send_dhcp_release(ip_src, ip_dst, xid, hostname='', iface=None, mac_src=None, port_src=68, printed=True):
    ...
    try:
        ...
        if printed:
            print(
                f"{Back}[{Purple}{iface}{Clear}{Back}] DHCP release: {Orange}{ip_src}{Clear}{Back} -> {Blue}{ip_dst}{Clear}{Back}: {Orange}{ip_src} {Dark_light_blue}has been released{Clear}")
