...
def send_dhcp_offer(ip_dst: str, ip_src: str, mac_dst: str, xid: int, lease_time: int=3600, sub_mask: str="255.255.255.0",
    ...
    try:
        ...
        if printed:
            print(
                f"{Back}[{Purple}{iface}{Clear}{Back}] DHCP offer: {Orange}{ip_src}{Clear}{Back} -> {Blue}{mac_dst}{Clear}{Back}: {Blue}{ip_dst}{Clear}{Back} {Dark_light_blue}is free. {Blue}{mac_dst}{Clear}{Back} {Dark_light_blue}can get it.{Clear}")
