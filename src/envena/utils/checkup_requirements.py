if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description=f"Start this module to check up installed requirements")
    parser.add_argument('--i-am-too-stupid', help="use this flag if you don't know how to use pip", action='store_true')
    ...
    if cli_args.i_am_too_stupid:
        try:
            ...
            if not 'ERROR' in result.stderr.upper():
                ...
                elif 'satisfied' in result.stdout.lower() or 'successfully' in result.stdout.lower():
                    OK_INSTALLED = True
